...
CREATE INDEX idx_staff_schedule_day ON staff_schedule (schedule_day);
...
(
    ...
    FOREIGN KEY (branch_id) REFERENCES branches (branch_id),
    UNIQUE(vec_id, booking_date, booking_time)
);

CREATE INDEX idx_booking_vehicle_date ON bookings (vec_id, booking_date);
